...
public class StudentInfoApplicataion {
	...
	public static void main(String[] args) {
		StudentInfoApplicataion test = new StudentInfoApplicataion();
	...
	public void createSubject() {
		korean = new Subject("국어", Define.KOREA); // 국어과목 생성
		math = new Subject("수학", Define.MATH); // 수학과목 생성
	...
	public void createStudent() {
		...
		Student student2 = new Student(181518, "차술기", math);
